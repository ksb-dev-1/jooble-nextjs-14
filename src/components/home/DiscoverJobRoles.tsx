  ...
  return (
    <div className="max-w-5xl w-full py-[4rem] px-4 hidden custom:block">
      <div className="">
        ...
        <div className="relative w-full h-[220px] flex items-center bg-white border border-slate-300 rounded-xl">
          ...
          <div className="absolute shadow-2xl right-5 bg-white border border-slate-300 flex flex-col items-center justify-center rounded-xl">
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center custom:hidden py-[2rem] md:py-[4rem] px-4">
      <div className="w-full">
        ...
        <div className="grid sm:grid-cols-2 gap-4 p-4 sm:p-8 bg-white border border-slate-300 rounded-xl">
