...
const Premium = () => {
  return (
    <div className="max-w-5xl w-full pt-[4rem] md:pt-[8rem] py-[2rem] md:py-[4rem] px-4">
      <div>
        <p className="text-xl font-bold mb-4">Premium services</p>
        <div className="bg-white border boredr-slate-300 rounded-xl flex flex-col lg:flex-row items-center lg:justify-between px-2 py-4 sm:px-8 sm:py-8">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:ml-4 mt-8 lg:mt-0">
              <p className="font-bold text-violet-600 sm:text-xl text-center lg:text-start">
          ...
          <Link
            href="#"
            className="bg-violet-600 hover:bg-violet-800 transition text-white mt-8 lg:mt-0 rounded-[50px] px-8 py-4"
          >
            Learn more
          </Link>
        </div>
